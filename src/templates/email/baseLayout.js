...
<body style="margin:0;padding:0;background:#f4f6f9;font-family:Inter,Arial,Helvetica,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f4f6f9;padding:32px 16px;">
    <tr>
      <td align="center">
        <!-- Main Email Wrapper -->
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          
          <!-- ⚡ HEADER -->
          <tr>
            <td style="background:${BRAND_DARK};padding:35px 20px 25px;text-align:center;border-bottom:3px solid ${BRAND_GOLD};">
              
              <!-- ⚡ EXTREMELY SMALL & CONTROLLED LOGO (For Tall Logos) -->
              <table width="65" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto; width:65px; max-width:65px;">
                <tr>
                  <td align="center" style="width:65px;">
                    <a href="${FRONTEND_URL}" style="text-decoration:none;display:block;">
                      <img
                        ...
                        alt="TRUEE"
                        width="65"
                        style="display:block;margin:0 auto;width:65px;max-width:65px;height:auto;border:0;outline:none;"
                      />
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin:16px 0 0;color:#9ca3af;font-size:10px;letter-spacing:0.3em;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif;">Premium Electronics</p>
            </td>
          </tr>

          <!-- ⚡ BODY CONTENT -->
          <tr>
            <td style="padding:40px;color:#333;font-size:15px;line-height:1.65;">
              ${bodyContent}
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#111111;padding:35px 20px;text-align:center;">
              <p style="margin:0 0 16px;color:${BRAND_GOLD};font-size:11px;font-weight:bold;text-transform:uppercase;letter-spacing:1.5px;">Need help?</p>
              
              <p style="margin:0 0 24px;">
                <a href="mailto:${process.env.EMAIL_SUPPORT_FROM || 'support@truee.in'}" style="color:#fff;font-size:12px;text-decoration:none;margin:0 12px;opacity:0.9;">Support</a>
                <a href="${FRONTEND_URL}/contact" style="color:#fff;font-size:12px;text-decoration:none;margin:0 12px;opacity:0.9;">Contact</a>
                <a href="${FRONTEND_URL}" style="color:#fff;font-size:12px;text-decoration:none;margin:0 12px;opacity:0.9;">Shop</a>
              </p>
              
              <!-- ⚡ TINY FOOTER LOGO -->
              <table width="40" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto; width:40px; max-width:40px;">
                <tr>
                  <td align="center" style="width:40px;">
                    <img src="${LOGO_URL}" alt="TRUEE" width="40" style="display:block;width:40px;max-width:40px;height:auto;opacity:0.3;border:0;" />
                  </td>
                </tr>
              </table>

              <p style="margin:20px 0 0;color:#555;font-size:11px;">© ${new Date().getFullYear()} TRUEE.IN — All rights reserved.</p>
            </td>
          </tr>
        </table>
      </td>
...
const ctaButton = (text, href) => `
  <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:30px auto;">
    <tr>
      <td align="center" style="background:${BRAND_DARK};border-radius:4px;">
        <a href="${href}" style="display:inline-block;padding:14px 40px;color:#fff;font-weight:600;text-decoration:none;font-size:13px;letter-spacing:1px;text-transform:uppercase;">${text}</a>
      </td>
    </tr>
  </table>`;
